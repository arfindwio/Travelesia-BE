...
const { getAllFlights, createFlight, getFlightById, editFlight, deleteFlight } = require("../controllers/flight.controllers");
...
router.put("/:flightId", Auth, checkRole(["ADMIN"]), image.single("image"), editFlight);
